...
$SelectDiskLabelText = "Seleccionar disco:"
$FreeSpaceLabelText = "Espacio libre (GB): "
$TotalSpaceLabelText = "Espacio total (GB): "
...
$BrowsersAreRunningText = "Los navegadores se están ejecutando... notificando al usuario..."
$PleaseCloseBrowsersText = "Cierre todos los navegadores web y vuelva a intentarlo"
$CleaningDriveText = "Limpiando disco..."
